...
public class Menu {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
				...
				case 1 -> {
					...
					System.out.println("\nA conta Numero: 1 foi criada com sucesso!");
					}
				case 2 ->{
					System.out.println("Digite o dia do Aniversario da Conta: ");
					aniversario = leia.nextInt();
					contas.cadastrar(new ContaPoupanca(contas.gerarNumero(), agencia, tipo, titular, saldo, aniversario));
					System.out.println("\n A conta numero: 2 foi criada com sucesso!");
				}
			...
			case 4:
				...
				var buscarConta = contas.procurarNaCollection(numero);
				...
				if(buscarConta != null) {
					...
					switch(tipo) {
						...
						case 2 ->{
						System.out.println("digite o dia do seu aniversario da conta: ");
						aniversario = leia.nextInt();
		...
		System.out.println("\n*********************************************************");
		System.out.println("Projeto Desenvolvido por: Isabella Correia dos Santos ");
